...
export class LPiece extends Piece {
    public getBlockLocations(angle: number = this.actualAngle): Phaser.Math.Vector2[] {
        switch (angle) {
            case 0:
                return [new Vector2(2, 0), new Vector2(0, 1), new Vector2(1, 1), new Vector2(2, 1)]
            case -180:
            case 180:
                return [new Vector2(0, 0), new Vector2(1, 0), new Vector2(2, 0), new Vector2(0, 1)]
            case 90:
                return [new Vector2(0, 0), new Vector2(0, 1), new Vector2(0, 2), new Vector2(1, 2)]
            case -90:
                return [new Vector2(0, 0), new Vector2(1, 0), new Vector2(1, 1), new Vector2(1, 2)]
            default:
